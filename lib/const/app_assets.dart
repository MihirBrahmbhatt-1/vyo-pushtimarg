...
class AppIcons {
  ...
  static IconData backArrow = Icons.arrow_back;
  static IconData backArrowiOS = Icons.arrow_back_ios_new_rounded;
    ...
    static String mobileOtpIcon = "assets/icons/otp-code.png";
}
